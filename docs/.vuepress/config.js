        ...
        '/基础/': [{
            ...
            },
            {
                ...
                children: [
                    ...
                    ['算法和数据结构/LRU.md', 'LRU'],
                    ['算法和数据结构/二叉树.md', '二叉树'],
                    ['算法和数据结构/归并排序.md', '归并排序'],
                    ['算法和数据结构/快排.md', '快排'],
                    ['算法和数据结构/Leetcode 买卖股票的最佳时机.md', '121.Leetcode买卖股票的最佳时机'],
                    ['算法和数据结构/插入排序.md', '插入排序'],
                    ['算法和数据结构/整数反转.md', '整数反转'],
            ...
            },
            {
                ...
                children: [
                    ...
                    ['/基础/工具/git.md', 'git'],
                    ['/基础/工具/githubpage.md', 'GithubPage'],
                ]
            },
        ],
